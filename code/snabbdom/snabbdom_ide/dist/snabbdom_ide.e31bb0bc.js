...
var _style = _interopRequireDefault(require("snabbdom/modules/style.js"));
...
function add() {
  var item = originalData[Math.floor(Math.random() * 10)];
  data = [{
    rank: nextKey++,
    title: item.title,
    desc: item.desc,
    elmHeight: item.elmHeight
  }].concat(data);
  render();
}
...
function render() {
  data = data.reduce(function (arr, item) {
...
function view(data) {
  return (0, _snabbdom.h)("div#app", [(0, _snabbdom.h)("h1.header", "Top 10 movies"), (0, _snabbdom.h)("div.title_box", [(0, _snabbdom.h)("span", "Sort by:"), (0, _snabbdom.h)("div.title", {
    class: {
      active: sortBy === 'rank'
    },
    on: {
  ...
  }, "Description"), (0, _snabbdom.h)("div.add.title", {
    on: {
      click: add
    }
  }, "Add")]), (0, _snabbdom.h)("div.list", {
    style: {
...
},{"snabbdom":"node_modules/snabbdom/es/snabbdom.js","snabbdom/modules/style.js":"node_modules/snabbdom/modules/style.js","snabbdom/modules/eventlisteners":"node_modules/snabbdom/modules/eventlisteners.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4458" + '/');
...
//# sourceMappingURL=/snabbdom_ide.e31bb0bc.js.map